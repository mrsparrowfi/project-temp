        ...
        <section id="app--container" className="app--container">
            <div id="header--content" className="header--content">
                ...
                <div className='category--items'>
                    ...
                    <h6 onClick={() => handleCategoryClick('Mugs')}> Mugs </h6> | 
                    <h6 onClick={() => handleCategoryClick('Water Bottle')}> Water Bottle </h6> | 
                    <h6 onClick={() => handleCategoryClick('Steel Tumbler')}> Steel Tumbler </h6> | 
                    <h6 onClick={() => handleCategoryClick('Pint Glass')}> Pint Glass </h6>
                    <div className="flex--space"></div>
                </div>
            </div>
