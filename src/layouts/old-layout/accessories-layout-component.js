        ...
        <section id="app--container" className="app--container">
            <div id="header--content" className="header--content">
                ...
                <div className='category--items'>
                    ...
                    <h6 onClick={() => handleCategoryClick('Face Masks')}> Face Masks </h6> | 
                    <h6 onClick={() => handleCategoryClick('Hats')}> Hats </h6> | 
                    <h6 onClick={() => handleCategoryClick('Phone Cases')}> Phone Cases </h6> | 
                    <h6 onClick={() => handleCategoryClick('Stickers')}> Stickers </h6> | 
                    <h6 onClick={() => handleCategoryClick('Bags')}> Bags </h6> | 
                    <h6 onClick={() => handleCategoryClick('Neck Gaiters')}> Neck Gaiters </h6> | 
                    <h6 onClick={() => handleCategoryClick('Stationery')}> Stationery </h6> | 
                    <h6 onClick={() => handleCategoryClick('Fanny Packs')}> Fanny Packs </h6> | 
                    <h6 onClick={() => handleCategoryClick('Socks')}> Socks </h6>
                    <div className="flex--space"></div>
                </div>
            </div>
