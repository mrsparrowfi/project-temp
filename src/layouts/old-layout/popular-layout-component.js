...
function LayoutComponent (props) {
    ...
    const filterMostVisitedProducts = selectedCategory !== 'All' ? data.filter((items) => items.category === selectedCategory) : data;
        ...
        <section id="app--container" className="app--container">
            ...
            <div className='card--container'>
                ...
                <div className="card--holder">
                    {
                        (filterMostVisitedProducts.length === 0) ? 
                            (
                            ...
                            (
                                filterMostVisitedProducts.slice(0, displayItems).map((item) => {
                                    return (
                    ...
                    {
                        displayItems < filterMostVisitedProducts.length && (
                            <>
                                <div 
