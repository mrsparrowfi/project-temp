...
function LayoutComponent (props) {
    ...
    const filterNewProducts = selectedCategory !== 'All' ? data.filter((items) => (items.category === selectedCategory) && (items.isNew === true) ) : data.filter((items) => items.isNew === true);
        ...
        <section id="app--container" className="app--container">
            <div id="header--content" className="header--content">
                ...
                <div className='category--items'>
                    ...
                    <h6 onClick={() => handleCategoryClick('Apparel')}> Apparels </h6> | 
                    <h6 onClick={() => handleCategoryClick('Homeware')}> Home & Decor </h6> | 
                    <h6 onClick={() => handleCategoryClick('Accessories')}> Accessories </h6> | 
                    <h6 onClick={() => handleCategoryClick('Drinkware')}> Drinkware </h6>
                    <div className="flex--space"></div>
                </div>
            </div>
                ...
                <div className="card--holder">
                    {
                        (filterNewProducts.length === 0) ? 
                            ...
                            (
                                filterNewProducts.slice(0, displayItems).map((item) => {
                                    return (
                    ...
                    {
                        displayItems < filterNewProducts.length && (
                            <>
                                <div 
